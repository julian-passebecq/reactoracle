...
export function KubernetesPage() {
  ...
  return <>
    ...
    <section className="sectionGap"><div className="sectionHeader"><div><Title3>Workloads</Title3><Text className="muted">Restart is available only when the Control API explicitly enables the mutation capability and the optional restart RBAC is installed. Jobs remain non-restartable.</Text></div></div><WorkloadTable workloads={workloads.data} machineId={overview.data.vm.id} allowRestart={capabilities.data?.restartWorkload === true} /></section>
  </>;
}
